...
import { ChevronRight, Instagram, Layers, ShieldCheck, Truck, Star, Phone, Mail, MapPin, Package } from 'lucide-react';

const values = [
  { icon: Layers, label: 'Pokemon TCG' },
  { icon: Star, label: 'Riftbound' },
  { icon: ShieldCheck, label: 'Güvenli Alışveriş' },
  { icon: Package, label: 'Hızlı Teslimat' },
];

const stats = [
  { number: '10.000+', label: 'Kart Çeşidi' },
  { number: '%100', label: 'Güvenli Ödeme' },
  { number: 'NM/LP', label: 'Kontrollü Kondisyon' },
  { number: '81', label: 'İl Teslimat' },
];

const features = [
  { icon: Star, title: 'Kondisyon Garantisi', desc: 'Her kart kondisyona göre sınıflandırılır: Near Mint, Lightly Played, Moderately Played.' },
  { icon: ShieldCheck, title: 'Güvenli Paketleme', desc: 'Kartlar sleeve, toploader ve bubble wrap ile koruma altında gönderilir.' },
  { icon: Truck, title: 'Hızlı Teslimat', desc: '81 ile özenli paketleme ve hızlı kargo imkânı.' },
  { icon: Package, title: 'Geniş Koleksiyon', desc: 'Pokemon TCG ve Riftbound\'dan single kart, booster box ve sealed ürünler.' },
];
