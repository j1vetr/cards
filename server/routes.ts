...
import { aiStatusHandler, aiTopicsHandler, aiGenerateHandler, aiFaqHandler, aiCoverHandler, aiOutlineHandler, aiTitlesHandler, aiSocialHandler } from './ai-blog';
...
`;
  ...
  app.post("/api/admin/blog/ai/outline", requireAdmin, aiOutlineHandler);
  app.post("/api/admin/blog/ai/titles", requireAdmin, aiTitlesHandler);
  ...
  app.post("/api/admin/blog/ai/social", requireAdmin, aiSocialHandler);
