...
export default function Register() {
  ...
  const inputCls =
    'h-11 bg-white/[0.06] border-white/[0.10] focus:border-[hsl(var(--polen-orange))] focus-visible:ring-0 focus-visible:ring-offset-0 rounded-lg text-white placeholder:text-white/20';
            ...
            <form onSubmit={handleSubmit} className="space-y-3.5">
                    ...
                    <button
                      ...
                      className={`h-11 border rounded-lg text-[11px] font-semibold tracking-[0.15em] uppercase transition-colors ${
                        formData.customerType === opt.value
                          ...
                          : 'border-white/10 bg-white/[0.04] text-white/40 hover:border-white/25 hover:text-white/60'
                      }`}
                    >
                      {opt.label}
                    </button>
              ...
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  className="w-full h-11 bg-white/[0.06] border border-white/[0.10] focus:border-[hsl(var(--polen-orange))] focus:outline-none rounded-lg px-4 text-white text-sm"
                >
                  {COUNTRIES.map((country) => (
                    <option key={country} value={country} style={{ background: '#0c1220', color: 'white' }}>{country}</option>
                  ))}
                </select>
              </div>
              ...
              <p className="text-[11px] text-white/20 text-center leading-relaxed">
                Kayıt olarak{' '}
                <span className="underline underline-offset-2 hover:text-white/40 transition-colors cursor-pointer">Kullanım Koşulları</span>
                {' '}ve{' '}
                <span className="underline underline-offset-2 hover:text-white/40 transition-colors cursor-pointer">Gizlilik Politikası</span>
