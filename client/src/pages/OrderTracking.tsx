...
export default function OrderTracking() {
  ...
  return (
    <div className="min-h-screen bg-[#080e1c] flex flex-col overflow-x-hidden">
      <SEO title="Sipariş Takip" description="Marka sipariş durumu sorgulama." url="/siparis-takip" noIndex />
      <Header />
      ...
      <main className="flex-1 px-4 sm:px-6 py-10">
        <div className="max-w-2xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 gap-4 mb-4">
              <div>
                ...
                <Input
                  ...
                  className="h-12 bg-[#080e1c] border-white/15 text-white placeholder:text-white/30 focus:border-polen-orange rounded-none"
            ...
            >
              {user ? (
                <Link
                  ...
                  className="flex items-center justify-between gap-3 bg-[#0e1424] border border-white/[0.08] hover:border-polen-orange/60 hover:bg-polen-orange/5 transition-colors px-5 py-4 group"
                ...
                >
                  ...
                  <ArrowRight
                    className="w-4 h-4 text-white/45 group-hover:text-polen-orange group-hover:translate-x-1 transition-all shrink-0"
                    strokeWidth={2.2}
                  />
                </Link>
              ) : (
          ...
          {order && (
            ...
            >
              {/* Sipariş üst bilgisi */}
              <div className="bg-[#0e1424] border border-white/[0.08] p-5 sm:p-6">
                <div className="flex items-start justify-between gap-4 flex-wrap">
                  ...
                  {currentStatus && (
                    <div className="text-right">
                      ...
                      <span
                        className="inline-flex items-center gap-2 px-3 py-1.5 bg-polen-orange/15 text-white border border-polen-orange/40 text-[12px] font-semibold tracking-[0.06em] uppercase"
              ...
              {order.paymentMethod === 'bank_transfer' && order.paymentStatus === 'awaiting_transfer' && (
                ...
                >
                  ...
                  <div className="bg-[#0e1424] border border-white/8 p-4 space-y-2 text-sm">
                ...
                <div className="bg-[#0e1424] border border-white/[0.08] p-5 sm:p-6">
                          ...
                          {!isLast && (
                            <span
                              ...
                              className={`absolute left-[18px] top-9 bottom-0 w-px ${
                                isCompleted ? 'bg-polen-orange' : 'bg-[#0e1424]/10'
                              }`}
                            />
                          )}
                          <div
                  ...
                  <div className="hidden sm:block">
                    <div className="flex justify-between items-start relative">
                      <div className="absolute left-5 right-5 top-5 h-px bg-[#0e1424]/10 z-0" />
                      <div
                            ...
                            <div
                              className={`w-10 h-10 rounded-full flex items-center justify-center transition-all ${
                                isCompleted || isCurrent
                                  ...
                                  : 'bg-[#080e1c] border border-white/15 text-white/35'
                              }`}
                            >
                              <StepIcon className="w-4 h-4" strokeWidth={2} />
                            </div>
              ...
              {order.trackingNumber && (
                <div
                  className="relative bg-[#0e1424] border border-polen-orange/40 p-5 sm:p-6"
                  ...
                  <div className="text-center mb-5">
                    ...
                    <div className="flex items-center justify-center gap-2">
                      ...
                      <button
                        ...
                        className="p-1.5 text-white/45 hover:text-polen-orange hover:bg-[#0e1424]/[0.08] transition-colors rounded shrink-0"
              ...
              <div className="grid sm:grid-cols-2 gap-5">
                <div className="bg-[#0e1424] border border-white/[0.08] p-5">
                ...
                <div className="bg-[#0e1424] border border-white/[0.08] p-5">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between text-[14px] font-bold text-white pt-2 border-t border-white/10">
                      <span>Toplam</span>
