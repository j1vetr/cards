      ...
      <main className="flex items-center justify-center min-h-[calc(100vh-72px)] px-5 py-12">
        ...
        >
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="h-11 pl-10 bg-white/5 border-white/10 focus:border-[hsl(var(--polen-orange))] focus-visible:ring-0 focus-visible:ring-offset-0 rounded-lg text-white placeholder:text-white/20"
                />
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="h-11 pl-10 pr-10 bg-white/5 border-white/10 focus:border-[hsl(var(--polen-orange))] focus-visible:ring-0 focus-visible:ring-offset-0 rounded-lg text-white placeholder:text-white/20"
                />
                <button
                  type="button"
          ...
          <p className="mt-8 text-center text-[11px] text-white/25">
            Giriş yaparak{' '}
            <span className="underline underline-offset-2 cursor-pointer hover:text-white/50 transition-colors">Kullanım Koşulları</span>
            {' '}ve{' '}
            <span className="underline underline-offset-2 cursor-pointer hover:text-white/50 transition-colors">Gizlilik Politikası</span>
